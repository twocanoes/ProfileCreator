...
extension NSToolbarItem.Identifier {
    ...
    static let mainWindowTitle = NSToolbarItem.Identifier("mainWindowTitle")
    ...
    static let preferencesMDM = NSToolbarItem.Identifier("preferencesMDM")
    static let preferencesProfileDefaults = NSToolbarItem.Identifier("preferencesProfileDefaults")
    static let preferencesPayloads = NSToolbarItem.Identifier("preferencesPayloads")
    static let preferencesAdvanced = NSToolbarItem.Identifier("preferencesAdvanced")
}
